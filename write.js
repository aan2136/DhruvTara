const fs = require('fs');
fs.mkdirSync('app/api/audio', { recursive: true });
fs.mkdirSync('public', { recursive: true });

// YAMNet audio classifier loaded in browser via TensorFlow.js
// Detects: screams, crying, shouting, glass breaking in real time
const audioDetector = `"use client";
...
fs.writeFileSync('app/components/AudioDetector.tsx', audioDetector, 'utf8');
fs.writeFileSync('app/map/page.tsx', map, 'utf8');
console.log('Full ML map ready!');